...
import Lesson7.project.components.WeatherResponse;
import Lesson7.project.components.ForecastResponse;
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                if (body != null) {
                    ...
                    var list = objectMapper.readValue(json, new TypeReference<List<WeatherResponse>>() { });
                    var item = list.get(0);
                    System.out.printf(
